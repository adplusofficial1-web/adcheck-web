  ...
  return (
        <main>
              ...
              <article className="max-w-3xl mx-auto px-6 py-14">
                      ...
                      <h1 className="text-3xl font-medium mb-3 leading-tight">{article.title}</h1>h1>
                      ...
                      <div className="rounded-lg border border-border bg-page p-5 mb-10">
                                <p className="text-sm font-medium text-primary mb-1">ที่มา</p>p>
                ...
                {more.length > 0 && (
                    <div className="mt-14 pt-10 border-t border-border">
                                <h2 className="text-lg font-medium mb-6">บทความอื่นๆ</h2>h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  {more.map((a) => (
                                      <Link
                                                        ...
                                                        <h3 className="text-base font-medium mb-2">{a.title}</h3>h3>
                                                        <p className="text-xs text-tertiary">{formatThaiDate(a.publishedAt)}</p>p>
                                      </Link>Link>
                                    ))}
                                </div>div>
                    </div>div>
