      ...
      <div className="max-w-5xl mx-auto px-6 py-14">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="border border-border rounded-lg p-5">
            <div className="text-xs text-secondary mb-2">เครดิตคงเหลือ (ใช้ร่วมกันทุกคลินิก)</div>
            ...
            {clinics.map((c) => {
              ...
              return (
                <div key={c.id} className="border border-border rounded-lg p-5">
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs truncate text-secondary">{c.contact_email || "ยังไม่มีอีเมลติดด่อ"}</div>
                      </div>
                    </div>
                    <Link
                  ...
                  <div className="text-xs mb-1.5 text-secondary">ผลีทรสศจเดือนนี้ ({total} ภาพ)</div>
