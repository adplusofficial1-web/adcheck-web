  ...
  return (
    <nav className="bg-inverse text-onInverse px-6 md:px-14 py-5">
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-8 min-w-0">
          ...
          <div className="flex items-center gap-3 shrink-0">
            {/* Shown here only at >=768px — below that, the small-screen
                menu row at the bottom of this nav renders its own
                ModeToggle instead, so the toggle isn't duplicated across
                the 640-768px range. ModeToggle's own root div has no
                breakpoint hiding any more (that's what caused it to vanish
                below 640px entirely — see the small-screen row below). */}
      ...
      {/* Small-screen menu: same items, wraps under the header row instead
          ...
          This is the only ModeToggle rendered below 768px (including
          phones under 640px, where it used to disappear entirely — H4). */}
