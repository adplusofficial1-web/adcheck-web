...
export function HunterHelpTab() {
  return (
    <div className="flex flex-col gap-4 max-w-2xl">
      ...
      <Section title="แชทกับทีมงาน">
        <p>
          มีคำถามเรื่องคลินิกที่ได้รับ การใช้งาน หรือค่าคอมมิชชั่น พิมพ์ถามทีมงาน AdCheck ได้โดยตรงในแท็บ &quot;แชทกับทีมงาน&quot;
          — ข้อความตอบกลับที่ยังไม่ได้อ่านจะขึ้นเป็นตัวเลขบนแท็บนั้น
        </p>
      </Section>
    </div>
  );
