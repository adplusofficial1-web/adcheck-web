...
// Admin > Marketing > Hunter — "Pipeline รวม ของ Hunter" section.
...
// to just the 6 status totals in one row (no per-Hunter breakdown, no
// merged Kanban board — those stay private to each Hunter on /hunter, see
...
const STAGES: { key: HunterPipelineStatus; label: string; dot: string; text: string }[] = [
