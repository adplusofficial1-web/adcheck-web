...
// Shared "บทความ" list UI for both /articles (clinic mode) and
// /agency/articles (agency mode) — the article content itself (lib/articles.ts)
// is identical either way, so this component is the single place that
// renders it; the two route files (app/articles/page.tsx and
// app/agency/articles/page.tsx) are thin wrappers that just pick the base
