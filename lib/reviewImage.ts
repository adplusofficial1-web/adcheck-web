...
เดิมมาประกอบการตัดสินหรืออ้างอิงเพิ่มเติมโดยเด็ดขาด แม้จะรู้สึกว่าเกี่ยวข้อง คุ้นเคย หรือน่าจะถูกต้องก็ดาม เหตุผลคือที౅ฆน
...
1. topic — หัวข้อหลักสั้นๆ (ไม่เกิน 6-8 คำ) สรูปว่าปัญหาคืออะไร เช่น "คำโฆษณาเกินจริงเรื่องผลลัพธ์การรักษา"
...
3. suggested_correction — คำแนะนำวิธีแก้ไขที่นำไปใช้ได้จริงทันที ความยาวไม่เกิน 1-2 บรรทัด ต้องระบุเจาะจงแต่สั้น เช่น
   ...
   ภาพก่อน-หลัง/การยินย�-ม ให้ระบุสั้นๆ ว่าฅ้องแนบหลักฐานอะไร (เช่น "แนบหนังสือยินย�-มเป็นลายลักษณ์อักษรจากเจ้าของภาพ")

ควบคุมความยาวรวมของคำตอบอย่างเคร่งครัด: ถ้าพบประเด็นความเสี่ยงมากกว่า 5 จุดในภาพเดียว ให้เลือกมาเฉพาะ 5 ประเด็นที่
ร้ายแรง/ชัดเจนที่สุดเท่านั้น (เรียงตามความรุนแลงและความชัดเจนของหลักฐาน) ห้ามพยายามระบุทุกประเด็นที่พบจนคำตอบยาวเกินไป
— เลือกน้อยจุดแต่สั้นกระชับและครบ�-งค์ประกอบ ดีกว่าพยายามใส่ทุกจุดจนคำตอบถูกตัดกลางคันและใช้งานไม่ได้เลย
